...
//
#line 47 "D:\CODE\VSProjects\MyDx12Demo\ep07_2_LandAndWaves\Shaders\color.hlsl"
mov r0.xyz, v0.xyzx
mov r0.w, l(1.000000)
...
#line 48
dp4 r0.x, r1.xyzw, cb1[16].xyzw  // r0.x <- vout.PosH.x
dp4 r0.y, r1.xyzw, cb1[17].xyzw  // r0.y <- vout.PosH.y
dp4 r0.z, r1.xyzw, cb1[18].xyzw  // r0.z <- vout.PosH.z
dp4 r0.w, r1.xyzw, cb1[19].xyzw  // r0.w <- vout.PosH.w
